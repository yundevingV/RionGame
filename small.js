    ...
    switch(e.keyCode) {
        case 13 :
            ...
            if (createSmallTime %20 == 1){                
                small = new createSmall(Math.random() * 700,0,40,30)
                small.draw()
                small1 = new createSmall(Math.random() * 700,0,40,30)
                small1.draw()
                small2 = new createSmall(Math.random() * 700,0,40,30)
                small2.draw()
                small3 = new createSmall(Math.random() * 700,0,40,30)
                small3.draw()
            }
                else {  
                    small.y +=100
                    ctx.clearRect(small.x,small.y-100,40,30)
                    small.draw()
                    small1.y +=100
                    ctx.clearRect(small1.x,small1.y-100,40,30)
                    small1.draw()            
                    small2.y +=100
                    ctx.clearRect(small2.x,small2.y-100,40,30)
                    small2.draw()

                    small3.y +=100
                    ctx.clearRect(small3.x,small3.y-100,40,30)
                    small3.draw()
            ...
            if (createSmallTime > 3 ){
            if (createSmallTime %20 ==4){                
                small4 = new createSmall(Math.random() * 700,0,40,30)
                small4.draw()
                small5 = new createSmall(Math.random() * 700,0,40,30)
                small5.draw()
                small6 = new createSmall(Math.random() * 700,0,40,30)
                small6.draw()
            }
            else {  
                small4.y +=100
                ctx.clearRect(small4.x,small4.y-100,40,30)
                small4.draw()
                small5.y +=100
                ctx.clearRect(small5.x,small5.y-100,40,30)
                small5.draw()            
                small6.y +=100
                ctx.clearRect(small6.x,small6.y-100,40,30)
                small6.draw()
            ...
            if (createSmallTime > 9){
            if (createSmallTime %20 == 10){                
                small7 = new createSmall(Math.random() * 700,0,40,30)
                small7.draw()
                small8 = new createSmall(Math.random() * 700,0,40,30)
                small8.draw()
                small9 = new createSmall(Math.random() * 700,0,40,30)
                small9.draw()
            }
            else {  
                small7.y +=100
                ctx.clearRect(small7.x,small7.y-100,40,30)
                small7.draw()
                small8.y +=100
                ctx.clearRect(small8.x,small8.y-100,40,30)
                small8.draw()            
                small9.y +=100
                ctx.clearRect(small9.x,small9.y-100,40,30)
                small9.draw()
